...
$conn = OpenCon();
$result = mysqli_query($conn,"SELECT * FROM course_split WHERE headline='B.Tech (Computer Science and Engineering)'");
?>
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active" href="btech(civil).php">B.Tech (Civil Engg.)</a>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="viewmechanicalattendance.php">B.Tech (Mechanical Engg.)</a>
                    </div>
                </div>
            </li>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
							...
							<?php
							            ...
							            $result1 = mysqli_query($conn,"SELECT * FROM course_split WHERE id=9");
                                        $row1= mysqli_fetch_array($result1);
                            ?>
							
                    <h1 class="h3 mb-2 text-gray-800"><?php echo $row1["headline"]; ?></h1>
                    <p class="mb-4">1st, 2nd, 3rd and 4th Year as of 2020</a>.</p>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-3" href="btech(cse-1st).html"><?php echo $row["headline"]; ?></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $row["year"]; ?></div>
                                        </div>
                                    <div class="row no-gutters align-items-right">
									    <a href="viewattendance.php?mechanicalyear=<?php echo $row["year"]; ?>" class="btn btn-primary btn-circle">
