...
$sql="INSERT INTO all_teachers (name, first_name, last_name, college_id, address, phone_number, email_id, department, city, postal, role, subject) VALUES ('$name','$first_name','$last_name','$college_id','$address','$phone_no','$email_id','$department','$city','$postal','Teacher','$subject')";
            ...
            <li class="nav-item active">
                ...
                <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="registerteacher.php">New Teacher</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Register New Teacher</h1>
                  ...
                  <div class="row">
					...
					<div class="col-lg-4">
                      <div class="form-group focused">
                        ...
                        <input type="text" name="department" class="form-control form-control-alternative" placeholder="Department" value="" required>
                      </div>
                    </div>
					<div class="col-lg-4">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-last-name">Subject</label>
                        <input type="text" name="subject" class="form-control form-control-alternative" placeholder="Subject" value="" required>
                      </div>
                    </div>
                    <div class="col-lg-4">
                      <div class="form-group focused">
