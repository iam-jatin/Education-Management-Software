...
<head>
    ...
    <title>Engineers Pro - B.Tech (CSE) Attendance</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="cseattendance.php">B.Tech (CSE)</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
							...
							<?php
							            ...
							            $result1 = mysqli_query($conn,"SELECT * FROM course_split WHERE id=1");
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-right">
									    <a href="takeattendance.php?cseyear=<?php echo $row["year"]; ?>" class="btn btn-primary btn-circle">
