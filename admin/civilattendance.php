...
$conn = OpenCon();
$result = mysqli_query($conn,"SELECT * FROM course_split WHERE headline='B.Tech (Civil Engineering)'");
?>
...
<head>
    ...
    <title>Engineers Pro - B.Tech (Civil) Attendance</title>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="civilattendance.php">B.Tech (Civil Engg.)</a>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-right">
									    <a href="takeattendance.php?civilyear=<?php echo $row["year"]; ?>" class="btn btn-primary btn-circle">
