...
$result = mysqli_query($db, "SELECT count(1) FROM all_students");
$row = mysqli_fetch_array($result);
$total = $row[0];

$result1 = mysqli_query($db, "SELECT count(1) FROM all_teachers WHERE role='Teacher'");
$row1 = mysqli_fetch_array($result1);
$total1 = $row1[0];

$result2 = mysqli_query($db, "SELECT count(1) FROM all_teachers WHERE role='Staff'");
...
<head>
    ...
    <title>Engineers Pro - A New Way to Connect</title>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-book-open fa-2x text-blue-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-success shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Total Years</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">4</div>
											
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-clock fa-2x text-blue-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-graduation-cap fa-2x text-blue-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-warning shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-chalkboard-teacher fa-2x text-blue-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card border-left-danger shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-id-card fa-2x text-blue-300"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
