            ...
            <li class="nav-item active">
                ...
                <div id="collapseUtilities" class="collapse show" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="viewcivilattendance.php">B.Tech (Civil Engg.)</a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
							...
							<?php
							            ...
							            $result1 = mysqli_query($conn,"SELECT * FROM course_split WHERE id=5");
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    ...
                                    <div class="row no-gutters align-items-right">
									    <a href="viewattendance.php?civilyear=<?php echo $row["year"]; ?>" class="btn btn-primary btn-circle">
