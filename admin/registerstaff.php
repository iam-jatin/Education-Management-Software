...
if(isset($_POST['submit'])){
     ...
     $city = $_POST['city'];
     $postal = $_POST['postal'];
$sql="INSERT INTO all_teachers (name, first_name, last_name, college_id, address, phone_number, email_id, department, city, postal, role) VALUES ('$name','$first_name','$last_name','$college_id','$address','$phone_no','$email_id','$department','$city','$postal','Staff')";
            ...
            <li class="nav-item active">
                ...
                <div id="collapseThree" class="collapse show" aria-labelledby="headingThree" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item active" href="registerstaff.php">New Staff</a>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <h1 class="h3 mb-4 text-gray-800">Register New Staff</h1>
